 ...
 * @author arvin
 */
public class Encap extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lyproject/Stealth (1) (3).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Encap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
