...
public class Log extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Stealth (1).png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
       ...
       if(founduser == null)
       {
            ...
            loginwrong logwr = new loginwrong(); //instance of login frame
            logwr.setVisible(true);
            logwr.pack();//resize to contain all components
            logwr.setLocationRelativeTo(null);// makes it center
            this.dispose();
        }
       ...
       else if(founduser != null && foundpass == null)
       {
            ...
            Select selectionframe = new Select(username);
